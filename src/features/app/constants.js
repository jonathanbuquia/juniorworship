...
export const ATTENDANCE_START_DATE = '2026-09-06'
...
export const MOON_JELLY_ATTENDANCE_BONUS = 300
export const MOON_JELLY_ATTENDANCE_CLAIMS_STORAGE_KEY = 'moon-jelly-attendance-bonus:v1'
